...
//  fields in isar nested object must be nullbale，which is a not a good design, so we abandon it for now
...
class BookInfo {
  ...
  String cover_s_url;
  String? ebook_url;
  //  Owners of the books are not stored in the client, as they are frequently changed
