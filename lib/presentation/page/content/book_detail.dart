            ...
            Expanded(
              child: Container(
                ...
                FilledButton(
                  ...
                  onPressed: ()=>_notifyWarning(S.of(context).cantReadOnline),
                  child: Text(
                    S.of(context).cantReadOnline,
                    style: Theme.of(context).textTheme.titleMedium?.copyWith(
                      color: Theme.of(context).colorScheme.primary,
                    ),
                  ),
            ...
            Expanded(
              child: Container(
                ...
                FilledButton(
                  ...
                  onPressed: ()=>_notifyWarning(S.of(context).noResouce),
                  child: Text(
                    S.of(context).noResouce,
                    style: Theme.of(context).textTheme.titleMedium?.copyWith(
                      color: Theme.of(context).colorScheme.surface,
                    ),
                  ),
