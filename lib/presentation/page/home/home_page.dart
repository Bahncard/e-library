              ...
              Padding(
                ...
                child: BoxGroove(
                  ...
                  widgets:List.generate(5,
                    (index) => CardLayout(
                      image: Image.asset(
                        'assets/images/activity/readingclub.png',
                        fit: BoxFit.contain,
                        width: AppRepreConst.grandCardW.w * 0.95,
                        height: AppRepreConst.grandCardW.w * AppRepreConst.cardRatio,
                      ),
                      title: S.of(context).readingclub,
                      subTitle: '2024.7.17-2024.7.27',
                      fontSize: 18.sp,
                      action: FilledButton(
                        onPressed: ()=>print(S.of(context).Details),
                        child: Text(
