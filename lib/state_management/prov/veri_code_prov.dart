...
class VeriCodeProv extends ChangeNotifier {
  ...
  String lastIdentifier='';// identifier to track to user sent the last request
  ...
  void startTimer(){
    if(timer!=null&&timer!.isActive&&lastIdentifier=='kexinsde@gmail.com'){
      return;
    }
    pauseInterval=0;
    lastIdentifier='kexinsde@gmail.com';
    // 计算距离上次发送验证码的时间
    left=gap;
